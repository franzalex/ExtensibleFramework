...
Public Class ActivityLauncher
    ...
    ''' <summary>
    ''' Initializes a new instance of the <see cref="ActivityLauncher" /> class.
    ''' </summary>
    ''' <param name="activityID">
    ''' The activity ID which will be used to launch the associated <see cref="ActivityControl" />.
    ''' </param>
    ...
    ''' Additional descriptive text for the <see cref="ActivityLauncher" />.
    ''' </param>
    ''' <remarks>The <paramref name="icon" /> should preferably be 32x32 pixels in size.</remarks>
    Public Sub New(activityID As String, caption As String, icon As Image, Optional description As String = "")
